...
public class App extends Application {
    ...
    public static final String URL_GOOGLE_PLAY_APP = "https://play.google.com/store/apps/details?id=jul.temporada";
    public static final String URL_DIRECT_GOOGLE_PLAY_APP = "market://details?id=jul.temporada";
    ...
    public static final String DB_NAME = "Alimentos.sqlite";
